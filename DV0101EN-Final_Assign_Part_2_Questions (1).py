...
# use groupby to create relevant data for plotting
        ...
        R_chart1 = dcc.Graph(figure=px.line(yearly_rec, 
            x='Year',
            y='Automobile_Sales',
            title="Avg Automobile Sales over Recession Period")
...
# use groupby to create relevant data for plotting
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec,
            values='Advertising_Expeniture',
            names='Vehicle_Type',
            title="Advertising Exp by Vehicle Type"
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemployment_rate,
            x='Vehicle_Type',
            y='Unemployment_Rate',
            title="Effect of Unemployment by Type")
...
# Plot 4 Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
            values='Advertising_Expeniture',
            names='Vehicle_Type',
            title="Yearly Advertising Exp by Vehicle Type")
